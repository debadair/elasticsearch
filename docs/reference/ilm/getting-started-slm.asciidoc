...
The Snapshot Lifecycle Management APIs enable you to automate the timing, frequency, and retention of snapshots. 
Snapshot Lifecycle Management is related to <<index-lifecycle-management,Index Lifecycle Management>>, 
but snapshot policies apply to multiple indices. 
