...
You use the following APIs to automatically manage the index lifecycle. 
See <<index-lifecycle-management,Managing the index lifecycle>> for more information
